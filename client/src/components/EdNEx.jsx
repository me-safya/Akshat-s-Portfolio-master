...
const currentJob = {
  ...
  endDate: "Present",
  responsibilities: [
    "Developed and delivered a Parts Overview tool, an internal data product built on Snowflake and Streamlit, with end-to-end ownership of both the data pipelines and application layer.",
